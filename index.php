...
<head>
    ...
    <!-- Title -->
    <title>Porão Academia | Home</title>
    ...
    <div class="fitness-working-hours-area section-padding-100-0">
        <div class="container">
            <div class="row">
                ...
                <!-- Our Novidadesletter Area -->
                <div class="col-12 col-lg-6">
                    <div class="our-Novidadesletter-area mb-100">
                        <div class="section-heading">
                            <h6>Fitness Gym</h6>
                            <h2>Our Novidadesletter</h2>
                        </div>

                        <!-- Novidadesletter Form -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget-area mb-50">
                            ...
                            <!-- Single Contato -->
                            <div class="single-contato.php mb-30">
                                <span>Address:</span>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Saçtz</a>
